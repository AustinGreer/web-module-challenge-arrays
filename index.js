...
function addFlavor(flavor, array){
    ...
    array.unshift(flavor);  //method adds item to beginning of array
    return array;           //if unshift method is returned, it will just give length of array. You need to return array after unshift method. 
...
function removeLastFlavor(array) {
    ...
    array.pop(); //method operates on the end of an array. 
...
//redefine problem: We need a function that takes array and string as parameters and the arguments should result in removing an item in array by string.
...
let copyFlavors = [];
console.log(copy(copyFlavors, originalFlavors));




/* Task 7: July 7th is "World Chocolate Day" and Baskin Robins wants to create promotional materials highlighting all of their chocolate flavors. Write a function that checks every item in the 
array for a given string and returns a new array called filteredArray with just these values. Rather than hardcoding "chocolate" into your function, pass a string as a parameter, and invoke 
with the argument "chocolate". This way you could also filter for "Vanilla", "Sherbert", etc. when those holidays roll around.
